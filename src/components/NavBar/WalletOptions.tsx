...
function WalletOption({
  ...
  return connector.name === 'MetaMask' ? (
    <button
      ...
      onClick={onClick}
      className="border bg-light-primary dark:bg-dark-primary border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:border-gray-700"
    >
      <svg
        aria-hidden="true"
